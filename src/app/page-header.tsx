...
export function PageHeader() {
  return <header className="bg-white relative after:content-[' '] after:absolute overflow-hidden
    ...
    <picture>
      <source srcSet="/images/geisel-library.webp" type="image/webp" media="(min-width: 480px)"/>
      <source srcSet="/images/geisel-library-small.webp" type="image/webp" />
      <Image src="/images/geisel-library-small.webp" alt="Geisel Library" width="1920" height="1080" priority={true}
    ...
    <div className='absolute top-1/2 translate-y-[-50%] w-full z-[1]'>
      ...
      <div className='min-[1500px]:scale-125 min-[1500px]:mt-24'>
        <CountdownTimer/>
        <a href="/winter2024/" className='group relative w-fit mt-16 mx-auto block px-5 py-2.5 bg-gradient-to-r from-[#FFE259] to-[#FFA751]
