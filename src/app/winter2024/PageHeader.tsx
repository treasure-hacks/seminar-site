...
function PhotoGrid() {
  return <div className="grid grid-cols-2 gap-8 rotate-12 top-[max(calc(40px-12vw),-160px)] right-[-9vw] w-[45vw] shrink-0 min-w-[600px] max-w-[800px]
    content-center -ml-16 absolute opacity-20 max-[960px]:w-[750px]">
...
export default function PageHeader() {
  return <header className="min-h-[75vh] max-w-[1600px] mx-auto relative pt-12 grid [grid-template-areas:'A_C''B_C'] content-center justify-center items-center
